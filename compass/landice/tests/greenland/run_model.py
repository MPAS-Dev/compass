...
from compass.model import add_model_as_input, make_graph_file, run_model
...
def collect(testcase, step):
    ...
    for suffix in step['suffixes']:
        add_namelist_file(
            step, 'compass.landice.tests.greenland', 'namelist.landice',
            out_name='namelist.{}'.format(suffix))

        add_streams_file(
            step, 'compass.landice.tests.greenland', 'streams.landice',
