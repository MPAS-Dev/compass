...
class Mesh(Step):
    ...
    def run(self):
       ...
       """
        ...
        build_planar_mesh(cell_width, x1, y1, geom_points, geom_edges, logger=logger)
    ...
    def build_cell_width(self):
        ...
        cell_width[np.logical_and(thk==0.0, distToEdge>20.0e3)] = maxSpac*1000.0 # put coarse res far out in non-ice area to keep mesh smaller in the part we are going to cull anyway (speeds up whole process)
