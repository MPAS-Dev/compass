...
class Forward(Step):
    ...
    def __init__(self, test_case, nonhydro_mode, name,
                 ntasks=8, min_tasks=1, openmp_threads=1):
        """
        ...
        self.add_namelist_file(
            'compass.ocean.tests.overflow.hydro_vs_nonhydro',
            'namelist.forward')
        if nonhydro_mode:
            self.add_namelist_file(
                'compass.ocean.tests.overflow.hydro_vs_nonhydro',
        ...
        self.add_streams_file('compass.ocean.tests.overflow.hydro_vs_nonhydro',
                              'streams.forward')
