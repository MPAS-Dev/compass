...
class InitialState(Step):
    """
    A step for creating a mesh and initial condition for
    hurricane with local time-stepping test cases

    Attributes
    ----------
    mesh : compass.ocean.tests.hurricane_lts.mesh.mesh.MeshStep
    ...
    def __init__(self, test_case, mesh):
        ...
        package = 'compass.ocean.tests.hurricane_lts.init'
