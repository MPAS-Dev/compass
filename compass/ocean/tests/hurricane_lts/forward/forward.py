...
class ForwardStep(Step):
    """
    A step for performing forward MPAS-Ocean runs as part
    of hurricane test with local time-stepping cases.
    ...
    def __init__(self, test_case, mesh, init, name='forward', subdir=None):
        ...
        Parameters
        ----------
        test_case : compass.ocean.tests.hurricane_lts.forward.Forward
        ...
        self.add_namelist_file(
            'compass.ocean.tests.hurricane_lts.forward', 'namelist.ocean')
